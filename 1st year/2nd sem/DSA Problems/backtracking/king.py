...
def king_backtracking(chessboard, x, y, curr):
    king_chessboard[x][y] = curr
    ...
    for to_x, to_y in zip(dx, dy):
        ...
        if is_safe(chessboard, new_x, new_y):
            king_backtracking(chessboard, new_x, new_y, curr + 1)


# king_backtracking(king_chessboard, start_x, start_y, 1)
